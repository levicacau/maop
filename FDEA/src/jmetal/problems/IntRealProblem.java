...
/**
 * Class representing a problem having N integer and M real variables. This is
 * not a true problem; it is only intended as an example
 */
public class IntRealProblem extends Problem {
	 ...
	 */
	public IntRealProblem(String solutionType, int intVariables,
			int realVariables) {
		...
		if (solutionType.compareTo("IntReal") == 0)
			solutionType_ = new IntRealSolutionType(this, intVariables,
					realVariables);
		else {
