	...
	public static void main(String args[]) throws JMException, ClassNotFoundException, SecurityException, IOException{
		...
		if (args.length == 1) {
			...
			if(fun==2){
			      ...
			      indicators = new QualityIndicator(problem, pathProblems+"DTLZ2.2D.pf");
			    	}
			if(fun==3){
			      problem = new DTLZ3("Real",10,2);			      
			      indicators = new QualityIndicator(problem, pathProblems+"DTLZ3.2D.pf" );
			    	}
			if(fun==6){
			...
			if(fun==13){
		  	      ...
		  	      indicators = new QualityIndicator(problem, pathProblems+"WFG1.2D.pf");
		  	    	}//problem = new WFG1("Real");
		  	if(fun==14){
		  	      problem = new WFG2("Real",2,20,2);
		  	      
		  	    indicators = new QualityIndicator(problem, pathProblems+"WFG2.2D.pf");
		  	    	}//problem = new WFG1("Real");
		  	if(fun==15){
		  	      problem = new WFG3("Real",2,20,2);
		  	      
		  	    indicators = new QualityIndicator(problem, pathProblems+"WFG3.2D.pf");
		  	    	}
			if(fun==16){
			      problem = new WFG9("Real",2,20,2);
			      
			      indicators = new QualityIndicator(problem, pathProblems+"WFG9.2D.pf");
			    	}//problem = new WFG1("Real");
			 if(fun==17){
