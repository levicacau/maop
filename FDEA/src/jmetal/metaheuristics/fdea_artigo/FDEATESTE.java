...
public class FDEATESTE extends Algorithm{
	...
	public SolutionSet execute() throws JMException, ClassNotFoundException {
		...
		targetEvaluations_ = maxEvaluations_/2;
...
//			targetEvaluation = maxEvaluations/2;
		...
		/* FOR CALCULATE GERATIONAL HV */
		int run_ = ((Integer) this.getInputParameter("run")).intValue();
...
//			System.out.println("Population size: "+population_.size());
			...
			if(evaluations_ == targetEvaluations_){
				population_.printVariablesToFile("results/FastFDEA_sol.txt");
				population_.printObjectivesToFile("results/FastFDEA_fronts.txt");
